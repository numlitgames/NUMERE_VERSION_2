...
const translations = {
  ...
  gameTitle: {
    ro: "Țări și Capitale", en: "Countries and Capitals", de: "Länder und Hauptstädte", fr: "Pays et Capitales",
    es: "Países y Capitales", it: "Paesi e Capitali", hu: "Országok és Fővárosok", cs: "Země a Hlavní Města",
    pl: "Kraje i Stolice", bg: "Страни и Столици", ru: "Страны и Столицы", ar: "البلدان والعواصم",
    pt: "Países e Capitais", tr: "Ülkeler ve Başkentler", el: "Χώρες και Πρωτεύουσες", ja: "国と首都"
  }
};
    ...
    <SidebarProvider>
      <div className="min-h-screen flex w-full">
        ...
        <div className="flex-1 flex flex-col">
          ...
          <main className="flex-1 bg-gradient-to-br from-amber-50 to-orange-50 p-4">
            <div className="max-w-6xl mx-auto">
              <Card className="border-2 border-amber-300">
                <CardHeader>
                  ...
                  <CardDescription>
                    Pregătim pentru tine o experiență interactivă de învățare a țărilor și capitalelor lumii.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="p-4 bg-amber-50 rounded-lg">
                      <h3 className="font-semibold text-lg mb-2">🌍 Europa</h3>
                      <p className="text-sm text-muted-foreground">
                        Descoperă țările și capitalele europene
                      </p>
                    </div>
                    <div className="p-4 bg-orange-50 rounded-lg">
                      <h3 className="font-semibold text-lg mb-2">🌎 America</h3>
                      <p className="text-sm text-muted-foreground">
                        Explorează continentul american
                      </p>
                    </div>
                    <div className="p-4 bg-rose-50 rounded-lg">
                      <h3 className="font-semibold text-lg mb-2">🌏 Asia</h3>
                      <p className="text-sm text-muted-foreground">
                        Învață despre țările asiatice
                      </p>
                    </div>
                    <div className="p-4 bg-red-50 rounded-lg">
                      <h3 className="font-semibold text-lg mb-2">🌍 Africa</h3>
                      <p className="text-sm text-muted-foreground">
                        Descoperă continentul african
                      </p>
                    </div>
                  </div>
                </CardContent>
